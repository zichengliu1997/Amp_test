...
with open('CurV 0gk 1.4V (100%) low and high pass flat stereo mode 1 Ohm.csv') as csvfile_1:
    pm = csv.reader(csvfile_1)
    for row in pm:
        x.append(float(row[3])*1000)
        curv10pc_y.append(float(row[4])*100)
        if (0.00004 < float(row[3])) and (float(row[3]) < 0.003):
            x1.append(float(row[3])*1000)
        if (0.000015 < float(row[3])) and (float(row[3]) < 0.000029):
            x2.append(float(row[3])*1000)

csvfile_1.close()

with open('ResisV 0gk 1.4V (100%) low and high pass flat stereo mode 1 Ohm.csv') as csvfile_2:
...
with open('PrimV 0gk 1.4V (100%) low and high pass flat stereo mode 1 Ohm.csv') as csvfile_3:
...
print("Slope of linear gain: " + str(slope) + ". ")
resv10pc_y11 = []
...
with open("Results_100% (1 ohm).txt", "w") as text_file:
...
plt.show()
plt.savefig("V vs. t (100%, 1 ohm).pdf")